...
def radar_selection(case_id, case_date):
    ...
    _time = time(int(startUTC[11:13]),0)
...
ds1.to_netcdf('/data2/willytsai/InSAR_HRRR/auto_framework/'+case_id+'/NEXRAD_refc_composite_hrrr.nc')
ds2 = eth_xr.to_dataset(name='eth')
ds2.to_netcdf('/data2/willytsai/InSAR_HRRR/auto_framework/'+case_id+'/NEXRAD_echotopheight_10dBZ_hrrr.nc')
